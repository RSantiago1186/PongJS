...
window.onload = function ()  {
		...
		function setup_canvas() {
				...
				context.fillRect(90, canvas.height - 95, 45, 40);
				context.fillRect(canvas.width - 110, 65, 45, 40);
		...
		function did_player_win(){
			if(player1_score === winning_score || player2_score === winning_score){
				...
				if (player2_score === winning_score){
					context.font = "24px serif";
					context.fillText("You Lost!", canvas.width/2 - canvas.width/14, canvas.height/2 + 25);
				}
			}
		}
